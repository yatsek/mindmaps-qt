...
class Form(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.switchButton.setFixedSize(40,30)#
        ...
        grid.addWidget(self.switchButton,0,1)#
        self.setLayout(grid)
        ...
        self.connect(self.switchButton,SIGNAL("clicked()"),self.swichCurrencies)#
        self.setWindowTitle("Currency")
    def swichCurrencies(self):#
        temp=self.toComboBox.currentIndex()#
        self.toComboBox.setCurrentIndex(self.fromComboBox.currentIndex())#
        self.fromComboBox.setCurrentIndex(temp)#
